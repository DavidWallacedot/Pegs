...
public class AdaptableTableDriver
{
   ...
   public static void main(String[] args)
   {
      ...
      st.tableRetrieve("We Are The Void");
      displayTable(st);
      st.tableRetrieve("Death...The Brutal Way");
      displayTable(st);
      st.tableRetrieve("Fragmentary Evidence");
      displayTable(st);
	...
	st.tableDelete("Esoteric");
	displayTable(st);
	st.tableDelete("Framing Armageddon");
	displayTable(st);
   }
